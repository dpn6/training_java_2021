...
//    Contacts before = app.contact().all();
    ...
    ContactData contact = new ContactData().withId(modifiedContact.getId()).withLastname("lastname")
            .withFirstname("name").withAddress("test3").withMobile("222").withEmail("polina@mail.ru");
